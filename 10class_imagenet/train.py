...
parser.add_argument('--beta2', type=float, default=0.9, metavar='rmsprop alpha', help='rmsprop alpha param (default: 0.9)')
...
optimizer = optim.RMSprop(generator.parameters(), lr=args.lr, alpha=args.beta2)
