...
transform = transforms.Compose([transforms.Resize((128, 128), interpolation=Image.BICUBIC), transforms.RandomHorizontalFlip(), transforms.ToTensor(), transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
...
if args.disc_mode == 'RP':
	...
	for i in range(args.ndiscriminators):
		disc = Discriminator(3, [128, 256, 512, 1024, 2048], 1, optim.Adam, args.lr, (args.beta1, args.beta2)).train()
