...
if args.disc_mode == 'RP':
	...
	D4 = Discriminator_f6_dense(ndf=16, nc=3, optimizer=optim.Adam, lr=args.lr, betas=(args.beta1, args.beta2)).train()
	D5 = Discriminator_f4_dense(ndf=64, nc=3, optimizer=optim.Adam, lr=args.lr, betas=(args.beta1, args.beta2)).train()
