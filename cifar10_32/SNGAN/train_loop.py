...
class TrainLoop(object):
	...
	def __init__(self, generator, fid_model, disc, optimizer, train_loader, its_disc, checkpoint_path=None, checkpoint_epoch=None, cuda=True):
	...
	def valid(self):
		...
		with torch.no_grad():
			...
			logits = self.fid_model.forward(x_gen.cpu(), downsample_=False).detach().numpy()
