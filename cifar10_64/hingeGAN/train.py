...
from common.discriminators import Discriminator_wgan_noproj
...
disc = Discriminator_wgan_noproj(3, [128, 256, 512, 1024], 1, optim.Adam, args.lr, (args.beta1, args.beta2), batch_norm=True).train()
