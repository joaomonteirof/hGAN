...
from common.discriminators import Discriminator_wgangp
import argparse
import os
...
disc = Discriminator_wgangp(3, [128, 256, 512, 1024], 1, optim.Adam, args.lr, (args.beta1, args.beta2), instance_norm=True).train()
