...
from common.discriminators import Discriminator_mnist_wgan
...
transform = transforms.Compose([transforms.Resize((28, 28), interpolation=Image.BICUBIC), transforms.RandomHorizontalFlip(), transforms.ToTensor(), transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))])
...
disc = Discriminator_mnist_wgan(optim.Adam, args.lr, (args.beta1, args.beta2)).train()
fid_model = cnn().eval()
